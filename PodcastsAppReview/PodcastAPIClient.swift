...
struct PodcastAPIClient {
    static func fetchPodcasts(completion: @escaping (Result<[Podcast],AppError>) -> ()) {
        
        let podcastEndpointString = "https://itunes.apple.com/search?media=podcast&limit=200&term=swift"
